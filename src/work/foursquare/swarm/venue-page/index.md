---
title: Venue Page
metaDesc: "The Swarm Venue Page redesign reintroduced rich venue details—photos, tips, and ratings—streamlining exploration within Swarm while bridging its handoff to City Guide."
...
banner:
  ...
  - url: /_/images/work/foursquare/swarm/venue-page/banner/phone7-3.png
    alt: text
responsibilities:
  ["Prototyping", "Sketching", "UI Design", "User Testing", "UX Design"]
team:
  [
    "Andrew Chao",
    "Tim Deng",
...
##### <span class="mono">01</span>&mdash;Discover

## Understanding the Problem

Before we dive in, it's important to note that Swarm did have a venue page, of sorts, at launch. As shown below, users could access specific details about a venue, including its address, the total and unique number of visitors, and a row showing if any friends had previously checked in. Additionally, information about the current Mayor<sup><a href="#fn-1" id="fnref-1" class="footnote">1</a></sup> was displayed at the bottom of the modal, along with a City Guide button that allowed users to browse a more comprehensive listing.

<figure class="img">
  <div class="bg padding multi row">
    <div>
      <img 
      src="{{ '/_/images/work/foursquare/swarm/saved-places/content/understanding-the-problem-screenshot-one.png' | url }}" 
      width="486" 
      alt="photo" />
    </div>
    <div>
      <img 
      src="{{ '/_/images/work/foursquare/swarm/saved-places/content/understanding-the-problem-screenshot-two.png' | url }}" 
      width="486" 
      alt="photo" />
    </div>
    <div>
      <img 
      src="{{ '/_/images/work/foursquare/swarm/saved-places/content/understanding-the-problem-screenshot-three.png' | url }}" 
      width="486" 
      alt="photo" />
    </div>
  </div>
...
##### <span class="mono">02</span>&mdash;Define
...
<figure class="img breakout">
<div>
<ul class="quotes grid grid-cols-4">
<li>
<div class="card">
<blockquote>
...
To guide this initiative, I facilitated a series of workshops to address a key challenge: how could we add meaningful venue details to Swarm without duplicating City Guide's functionality? By aligning stakeholders on this goal, we crafted user stories that focused on simplifying the venue discovery process while reinforcing Swarm's social-first identity<sup><a href="#fn-2" id="fnref-2" class="footnote">2</a></sup>. Through competitor analysis, I identified design patterns that balanced rich information with social interactivity. These findings helped shape early creative explorations, where mood boards and content blocks helped visualise how Swarm could uniquely present venue details without compromising its playful, social tone.

##### <span class="mono">03</span>&mdash;Ideate
...
<figure class="img">
  <div class="multi col">
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/venue-page/content/entry-point-sketch-one.png' | url }}" 
        width="746" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/venue-page/content/entry-point-sketch-two.png' | url }}" 
        width="746" 
        alt="photo" />
      </div>
    </div>
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/venue-page/content/entry-point-wireframe-one.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/venue-page/content/entry-point-wireframe-two.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/venue-page/content/entry-point-wireframe-three.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
    </div>
      ...
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/venue-page/content/entry-point-mock-one.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/venue-page/content/entry-point-mock-two.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/venue-page/content/entry-point-mock-three.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
    </div>
...
Each concept raised interesting questions about Swarm's purpose and how venue details should integrate with its core social features. While dynamic elements like the bottom sheet introduced new paradigms, they did so at the risk of Swarm's social focus with features like stats<sup><a href="#fn-3" id="fnref-3" class="footnote">3</a></sup> and comments from friends potentially being obscured or deprioritised. Conversely, the static area and card designs were straightforward but less engaging, potentially missing opportunities to enhance interaction.
...
<figure class="img">
    <div>
      <img 
      src="{{ '/_/images/work/foursquare/swarm/venue-page/content/entry-point-card-mock.png' | url }}" 
      width="1252" 
      alt="photo" />
    </div>
    <figcaption>
...
<figure class="img">
  <div class="multi col">
    <div class="multi row bg padding">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/venue-page/content/photo-carousel-empty-states.png' | url }}" 
        width="1252" 
        alt="photo" />
      </div>
    </div>
...
- **Save**: With us concurrently developing a [saved/visited feature][1], this felt essential. Saving a venue represents user intent and bridges City Guide, where saved places could be categorised further.
...
<figure class="img">
  <div class="multi col">
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/venue-page/content/content-as-a-framework-sketch.png' | url }}" 
        width="1252" 
        alt="photo" />
      </div>
    </div>
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/venue-page/content/content-as-a-framework-wireframe-one.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/venue-page/content/content-as-a-framework-wireframe-two.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/venue-page/content/content-as-a-framework-wireframe-three.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
    </div>
...
<figure class="img">
  <div class="multi col">
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/venue-page/content/showcasing-social-content-sketch-one.png' | url }}" 
        width="1252" 
        alt="photo" />
      </div>
    </div>
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/venue-page/content/venue-wireframe-one.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/venue-page/content/venue-wireframe-two.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/venue-page/content/venue-wireframe-three.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
    </div>
...
<figure class="img">
  <div class="multi col">
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/venue-page/content/showcasing-social-content-sketch-two.png' | url }}" 
        width="1252" 
        alt="photo" />
      </div>
    </div>
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/venue-page/content/venue-wireframe-four.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/venue-page/content/venue-wireframe-five.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/venue-page/content/venue-wireframe-six.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
    </div>
...
##### <span class="mono">04</span>&mdash;Test
...
To gather diverse perspectives, we established a steady feedback loop, sharing weekly builds with employees and fortnightly updates with Superusers<sup><a href="#fn-5" id="fnref-5" class="footnote">5</a></sup>. Superusers were given a dedicated Slack channel to share images, screen recordings, and detailed feedback. This collaborative space not only uncovered usability challenges early but also generated innovative ideas that influenced the direction of the design.
...
<figure class="img">
  <div class="multi col bg padding">
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/venue-page/content/design-revisions-mock-one.png' | url }}" 
        width="746" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/venue-page/content/design-revisions-mock-two.png' | url }}" 
        width="746" 
        alt="photo" />
      </div>
    </div>
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/venue-page/content/design-revisions-mock-three.png' | url }}" 
        width="746" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/venue-page/content/design-revisions-mock-four.png' | url }}" 
        width="746" 
        alt="photo" />
      </div>
    </div>
...
##### <span class="mono">05</span>&mdash;Release
...
<ol id="footnotes">
  <li id="fn-1">
    The user with the most check-ins at a venue over 30 days.
    <a class="data-footnote-backref" href="#fnref-1">↩</a>
  </li>
  <li id="fn-2">
    Seeing the context of a check-in in the Swarm social feed and getting a sense of what my friend(s) or other Foursquare users thought about the venue via the rating, tips and photos uploaded to that check-in/venue.
    <a class="data-footnote-backref" href="#fnref-2">↩</a>
  </li>
  <li id="fn-3">
    A feature that provided users with statistics highlighting their relationship with the venue.
    <a class="data-footnote-backref" href="#fnref-3">↩</a>
  </li>
  <li id="fn-4">
    Foursquare has consistently prioritised safeguarding user privacy, with a firm commitment to preventing the misuse of location data. <a href="https://location.foursquare.com/legal/privacy-center/">Learn more about our approach to location data privacy</a>.
    <a class="data-footnote-backref" href="#fnref-4">↩</a>
  </li>
  <li id="fn-5">
    Superusers (SUs) are the driving force behind the Foursquare community, tirelessly working to ensure the places database remains accurate and reliable.
    <a class="data-footnote-backref" href="#fnref-5">↩</a>
  </li>
</ol>

[1]: /work/foursquare/swarm/saved-places/
