---
title: PCI Cards
metaDesc: "The PCI Cards redesign refreshed Swarm’s post check-in insights with dynamic trivia, user-generated content, and a modern visual language to boost engagement."
...
We carefully examined data from the existing PCI cards to gain insights into user engagement, and our analysis revealed that some cards experienced a noticeable drop<sup><a href="#fn-1" id="fnref-1" class="footnote">1</a></sup> in interaction.
...
Structured brainstorming sessions enabled us to explore various trivia ideas and assess their potential impact while continuous feedback loops—gathered through company-wide polls on Slack<sup><a href="#fn-2" id="fnref-2" class="footnote">2</a></sup>—further enriched our question set, making it more relevant and compelling.
...
<figure class="img">
  <div class="multi col">
    <div class="multi col">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/pci-cards/content/new-concepts-sketch-one.png' | url }}" 
        width="1252" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/pci-cards/content/new-concepts-sketch-two.png' | url }}" 
        width="1252" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/pci-cards/content/new-concepts-sketch-three.png' | url }}" 
        width="1252" 
        alt="photo" />
      </div>
    </div>
    <div class="multi row">
      <div>
        <div>
          <img 
          src="{{ '/_/images/work/foursquare/swarm/pci-cards/content/new-concepts-wireframe-one.png' | url }}" 
          width="486" 
          alt="photo" />
        </div>
      </div>
      <div>
        <div>
          <img 
          src="{{ '/_/images/work/foursquare/swarm/pci-cards/content/new-concepts-wireframe-two.png' | url }}" 
          width="486" 
          alt="photo" />
        </div>
      </div>
      <div>
        <div>
          <img 
          src="{{ '/_/images/work/foursquare/swarm/pci-cards/content/new-concepts-wireframe-three.png' | url }}" 
          width="486" 
          alt="photo" />
        </div>
      </div>
...
<figure class="img">
  <div class="multi col">
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/pci-cards/content/new-aesthetics-one.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/pci-cards/content/new-aesthetics-two.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/pci-cards/content/new-aesthetics-three.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
    </div>
...
<ol id="footnotes">
  <li id="fn-1">
    It was our opinion that user fatigue played a considerable part in their decline, with users determining that they offered little new value to them.
    <a class="data-footnote-backref" href="#fnref-1">↩</a>
  </li>
  <li id="fn-2">
    Slack was quickly becoming a go-to resource when employees/teams wanted to obtain feedback in a timely fashion.
