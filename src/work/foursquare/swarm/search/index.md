---
title: Search
metaDesc: "The Swarm Search redesign unified fragmented search flows into a single, intuitive hub—combining history, friends, and places with faster results and smarter filtering."
...
<span class="persona">{% personasvg "two.svg" %}</span>
</div>
</li>
<li>
<div class="card">
...
<span class="persona">{% personasvg "five.svg" %}</span>
</div>
</li>
<li>
<div class="card">
...
<span class="persona">{% personasvg "four.svg" %}</span>
</div>
</li>
<li>
<div class="card">
...
<span class="persona">{% personasvg "one.svg" %}</span>
</div>
</li>
</ul>
</div>
  ...
  <div class="multi col">
    <div class="multi row">
      <div>
        <div>
          <img 
          src="{{ '/_/images/work/foursquare/swarm/search/content/identifying-an-entry-point-sketch.png' | url }}" 
          width="1252" 
          alt="photo" />
        </div>
      </div>
    ...
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/search/content/identifying-an-entry-point-wireframe-one.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/search/content/identifying-an-entry-point-wireframe-two.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/search/content/identifying-an-entry-point-wireframe-three.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
    </div>
...
As Swarm requested location permissions during its initial setup<sup><a href="#fn-3" id="fnref-3" class="footnote">3</a></sup> one of our favoured approaches was to introduce a suggested searches feature that would be visible to all users.
...
<figure class="img">
  <div class="multi col">
    <div class="multi row">
      ...
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/search/content/landing-page-experiences-sketch.png' | url }}" 
        width="746" 
        alt="photo" />
      </div>
    </div>
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/search/content/landing-page-experiences-wireframe-one.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/search/content/landing-page-experiences-wireframe-two.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/search/content/landing-page-experiences-wireframe-three.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
    </div>
  ...
  <div class="multi col">
    <div class="multi row">
      <div>
        <div>
          <img 
          src="{{ '/_/images/work/foursquare/swarm/search/content/searching-for-results-sketch.png' | url }}" 
          width="1252" 
          alt="photo" />
        </div>
      </div>
    ...
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/search/content/searching-for-results-wireframe-one.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/search/content/searching-for-results-wireframe-two.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/search/content/searching-for-results-wireframe-three.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
    </div>
...
Ultimately, the contextual grouping approach proved the most effective. By prioritising places, locations, categories, and friends, we created a clean, scannable interface that balanced familiarity<sup><a href="#fn-4" id="fnref-4" class="footnote">4</a></sup> with functionality. Instead of fragmenting results by specific criteria, we focused on intuitive groupings, dynamically refining results with each keystroke.
...
<figure class="img">
  <div class="multi col">
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/search/content/diving-deeper-into-search-wireframe-one.png' | url }}" 
        width="358" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/search/content/diving-deeper-into-search-wireframe-two.png' | url }}" 
        width="358" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/search/content/diving-deeper-into-search-wireframe-three.png' | url }}" 
        width="358" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/search/content/diving-deeper-into-search-wireframe-four.png' | url }}" 
        width="358" 
        alt="photo" />
      </div>
    </div>
...
<figure class="img">
  <div class="multi col">
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/search/content/searching-through-time-wireframe-one.png' | url }}" 
        width="358" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/search/content/searching-through-time-wireframe-two.png' | url }}" 
        width="358" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/search/content/searching-through-time-wireframe-three.png' | url }}" 
        width="358" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/search/content/searching-through-time-wireframe-four.png' | url }}" 
        width="358" 
        alt="photo" />
      </div>
    </div>
    <div class="multi row">
      <div style="background:var(--border);">
        <img 
        src="{{ '/_/images/work/foursquare/swarm/search/content/searching-through-time-icon-one.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div style="background:var(--border);">
        <img 
        src="{{ '/_/images/work/foursquare/swarm/search/content/searching-through-time-icon-two.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div style="background:var(--border);">
        <img 
        src="{{ '/_/images/work/foursquare/swarm/search/content/searching-through-time-icon-three.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
    </div>
...
<figure class="img">
  <div class="multi col bg padding">
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/search/content/design-revisions-mock-one.png' | url }}" 
        width="746" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/search/content/design-revisions-mock-two.png' | url }}" 
        width="746" 
        alt="photo" />
      </div>
    </div>
...
<ol id="footnotes">
  <li id="fn-1">
    If you're interested in reading more on the last option, please feel free to read the <a href="/work/foursquare/swarm/venue-page/">case study</a> on Swarm's Venue Page.
    <a class="data-footnote-backref" href="#fnref-1">↩</a>
  </li>
  <li id="fn-2">
    The tab bar supported the 'Me' and 'Social' feeds, with the check‐in button centred for balance and prominence. Adding search here would require redesigning and reducing the check‐in button's importance.
    <a class="data-footnote-backref" href="#fnref-2">↩</a>
  </li>
  <li id="fn-3">
    If you'd like to learn more about Location Permissions, check out the official documentation from <a href="https://support.apple.com/en-us/102515">Apple</a> and <a href="https://developer.android.com/develop/sensors-and-location/location/permissions
    ">Android</a> for detailed specifications and guidelines
    <a class="data-footnote-backref" href="#fnref-3">↩</a>
  </li>
   <li id="fn-4">
    This unified interface not only streamlined search but also reinforced that all previous search experiences were now consolidated, simplifying navigation and encouraging exploration.
