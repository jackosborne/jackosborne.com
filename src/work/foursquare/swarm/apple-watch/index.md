---
title: Apple Watch
metaDesc: "The Swarm Apple Watch redesign streamlined check-ins, added stickers and detail views, and improved performance for faster, more intuitive on-the-go interactions."
...
<figure class="img">
  <div class="bg padding">
    <div style="max-width: 486px; margin: 0 auto;">
      <img 
      src="{{ '/_/images/work/foursquare/swarm/apple-watch/content/old-design.png' | url }}" 
      width="1252" 
      alt="photo" />
    </div>
  </div>
...
<figure class="img">
  <div class="multi col">
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/apple-watch/content/increasing-installation-awareness-sketch.png' | url }}" 
        width="1252" 
        alt="photo" />
      </div>
    </div>
    <div class="multi row">
      <div class="bg padding">
        <img 
        src="{{ '/_/images/work/foursquare/swarm/apple-watch/content/increasing-installation-awareness-wireframe.png' | url }}" 
        width="1252" 
        alt="photo" />
      </div>
    </div>
...
With the release of watchOS 4, Apple introduced "complications"<sup><a href="#fn-2" id="fnref-2" class="footnote">2</a></sup> which offered the ability to display timely, relevant information on the watch face, where people can view it each time they raise their wrist.
...
<figure class="img">
  <div class="multi col">
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/apple-watch/content/uncomplicated-complications-wireframe-one.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/apple-watch/content/uncomplicated-complications-wireframe-two.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/apple-watch/content/uncomplicated-complications-wireframe-three.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
    </div>
...
<figure class="img">
  <div class="multi col">
    <div class="multi row">
      <img 
      src="{{ '/_/images/work/foursquare/swarm/apple-watch/content/venue-picker-redesign-sketch.png' | url }}" 
      width="1252" 
      alt="photo" />
    </div>
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/apple-watch/content/venue-picker-redesign-wireframe-one.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/apple-watch/content/venue-picker-redesign-wireframe-two.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/apple-watch/content/venue-picker-redesign-wireframe-three.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
    </div>
...
<figure class="img">
  <div class="multi col">
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/apple-watch/content/sticker-flow-redesign-sketch.png' | url }}" 
        width="1252" 
        alt="photo" />
      </div>
    </div>
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/apple-watch/content/sticker-flow-redesign-wireframe-one.png' | url }}" 
        width="358" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/apple-watch/content/sticker-flow-redesign-wireframe-two.png' | url }}" 
        width="358" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/apple-watch/content/sticker-flow-redesign-wireframe-three.png' | url }}" 
        width="358" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/apple-watch/content/sticker-flow-redesign-wireframe-four.png' | url }}" 
        width="358" 
        alt="photo" />
      </div>
    </div>
...
<figure class="img">
  <div class="multi col">
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/apple-watch/content/checkin-flow-redesign-sketch.png' | url }}" 
        width="1252" 
        alt="photo" />
      </div>
    </div>
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/apple-watch/content/checkin-flow-redesign-wireframe-one.png' | url }}" 
        width="358" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/apple-watch/content/checkin-flow-redesign-wireframe-two.png' | url }}" 
        width="358" 
        alt="photo" />
      </div>
      <div>
      ...
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/apple-watch/content/checkin-flow-redesign-wireframe-three.png' | url }}" 
        width="358" 
        alt="photo" />
      </div>
    </div>
...
<figure class="img">
  <div class="multi col bg padding">
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/apple-watch/content/testing-and-feedback-wireframe-one.png' | url }}" 
        width="358" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/apple-watch/content/testing-and-feedback-wireframe-two.png' | url }}" 
        width="358" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/apple-watch/content/testing-and-feedback-wireframe-three.png' | url }}" 
        width="358" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/apple-watch/content/testing-and-feedback-wireframe-four.png' | url }}" 
        width="358" 
        alt="photo" />
      </div>
    </div>
...
<ol id="footnotes">
  <li id="fn-1">
    Unfortunately the watch app hadn't received much publicity on its initial launch as we had worked under the assumption that it would have been a lot more noticeable from within app store pages.
    <a class="data-footnote-backref" href="#fnref-1">↩</a>
  </li>
  <li id="fn-2">
    Refer to <a href="https://developer.apple.com/design/human-interface-guidelines/complications"> Apple's Human Interface Guidelines (HIG)</a> for detailed guidance on designing practical Complications.
