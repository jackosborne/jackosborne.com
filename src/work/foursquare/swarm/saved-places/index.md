---
title: Saved Places
metaDesc: "Saved Places reintroduced venue saving to Swarm, bridging the gap between discovery and personal exploration with an integrated map and bottom sheet design."
...
<figure class="img">
  <div class="bg padding multi row">
    ...
    <div>
      <img 
      src="{{ '/_/images/work/foursquare/swarm/saved-places/content/understanding-the-problem-screenshot-four.png' | url }}" 
      width="358" 
      alt="photo" />
    </div>
  </div>
...
User reviews from the app stores, along with insights from our community of Superusers<sup><a href="#fn-1" id="fnref-1" class="footnote">1</a></sup>, played a pivotal role in defining this new feature. This feedback highlighted clear opportunities for improvement and underscored the need for a redesign that prioritised a seamless and intuitive experience for saving and sharing places.
...
<figure class="img">
  <div>
    <img 
    src="{{ '/_/images/work/foursquare/swarm/saved-places/content/saving-venues-mock-one.png' | url }}" 
    width="1252" 
    alt="photo" />
  </div>
  <figcaption>
...
<figure class="img">
  <div>
    <div class="multi row">
      ...
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/saved-places/content/saving-venues-mock-two.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/saved-places/content/saving-venues-mock-three.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
    </div>
...
As a result, the user's profile emerged as a natural and prominent choice for this feature, as it already housed significant app usage information: photos, friends, check-ins<sup><a href="#fn-3" id="fnref-3" class="footnote">3</a></sup>, categories, stickers, streaks, and mayorships.

<figure class="img">
  <div class="multi row">
    <div>
      <img 
      src="{{ '/_/images/work/foursquare/swarm/saved-places/content/housing-the-experience-mock-one.png' | url }}" 
      width="486" 
      alt="photo" />
    </div>
    <div>
      <img 
      src="{{ '/_/images/work/foursquare/swarm/saved-places/content/housing-the-experience-mock-two.png' | url }}" 
      width="486" 
      alt="photo" />
    </div>
    <div>
      <img 
      src="{{ '/_/images/work/foursquare/swarm/saved-places/content/housing-the-experience-sketch.png' | url }}" 
      width="486" 
      alt="photo" />
    </div>
  </div>
...
<figure class="img">
  <div class="multi col">
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/saved-places/content/exploring-bottom-sheets-sketch.png' | url }}" 
        width="1252" 
        alt="photo" />
      </div>
    </div>
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/saved-places/content/exploring-bottom-sheets-wireframe-one.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/saved-places/content/exploring-bottom-sheets-wireframe-two.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/saved-places/content/exploring-bottom-sheets-wireframe-three.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
    </div>
...
<figure class="img">
  <div class="multi col">
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/saved-places/content/exploring-bottom-sheets-wireframe-four.png' | url }}" 
        width="358" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/saved-places/content/exploring-bottom-sheets-wireframe-five.png' | url }}" 
        width="358" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/saved-places/content/exploring-bottom-sheets-wireframe-six.png' | url }}" 
        width="358" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/saved-places/content/exploring-bottom-sheets-wireframe-seven.png' | url }}" 
        width="358" 
        alt="photo" />
      </div>
    </div>
...
<figure class="img">
  <div class="multi col">
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/saved-places/content/map-bottom-sheet-interactivity-wireframe-one.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/saved-places/content/map-bottom-sheet-interactivity-wireframe-two.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/saved-places/content/map-bottom-sheet-interactivity-wireframe-three.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
    </div>
...
<figure class="img">
  <div class="multi col bg padding">
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/saved-places/content/testing-and-feedback-sketch.png' | url }}" 
        width="1252" 
        alt="photo" />
      </div>
    </div>
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/saved-places/content/design-revisions-mock-one.png' | url }}" 
        width="746" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/swarm/saved-places/content/design-revisions-mock-two.png' | url }}" 
        width="746" 
        alt="photo" />
      </div>
    </div>
...
<ol id="footnotes">
  <li id="fn-1">
    Superusers (SUs) are the passionate backbone of the Foursquare community, dedicated to maintaining the accuracy and quality of the company's places database.
    <a class="data-footnote-backref" href="#fnref-1">↩</a>
  </li>
  <li id="fn-2">
    If you're curious about our decision-making process, you can dive into the details in this <a href="/work/foursquare/swarm/venue-page/">case study</a>.
    <a class="data-footnote-backref" href="#fnref-2">↩</a>
  </li>
  <li id="fn-3">
    The key distinction between Check-ins and Visited Places lies in their focus: while Check-ins provided a chronological list of all your activities, Visited Places would consolidate multiple check-ins at the same venue into a single grouping.
    <a class="data-footnote-backref" href="#fnref-3">↩</a>
  </li>
   <li id="fn-4">
    Research had consistently shown our users being firmly divided between the two approaches: lists vs. maps.
