---
title: Opinionator
metaDesc: "The City Guide Opinionator redesign refined Foursquare’s contribution flow with tailored questions, clearer progress, and expertise rewards to boost engagement and accuracy."
...
<figure class="img">
  <div class="bg padding">
    <img 
    src="{{ '/_/images/work/foursquare/city-guide/opinionator/content/venue-page-navigation.png' | url }}" 
    width="1252" 
    alt="photo" />
  </div>
  <figcaption>
...
An analysis revealed several areas for improvement, particularly around user fatigue with the feature. Many found the feature slow, confusing, and cumbersome, disrupting their browsing experience and creating a disconnect from the rest of the app<sup><a href="#fn-1" id="fnref-1" class="footnote">1</a></sup>.
...
<span class="persona">{% personasvg "three.svg" %}</span>
</div>
</li>
</ul>
</div>
...
To address this, we decided to group questions into three categories: novice, intermediate, and expert<sup><a href="#fn-2" id="fnref-2" class="footnote">2</a></sup>. For new users, we focused on foundational questions designed to boost their confidence and encourage further engagement with the feature. We surfaced more detailed and personalised questions for highly active, long-term users familiar with specific categories or venues that we assumed only they could answer.
...
<figure class="img">
  <div class="multi col">
    <div class="multi row">
      <img 
      src="{{ '/_/images/work/foursquare/city-guide/opinionator/content/stripping-back-sketch-one.png' | url }}" 
      width="1252" 
      alt="photo" />
    </div>
    <div class="multi row">
      <img 
      src="{{ '/_/images/work/foursquare/city-guide/opinionator/content/stripping-back-sketch-two.png' | url }}" 
      width="1252" 
      alt="photo" />
    </div>
    <div class="multi row">
      <img 
      src="{{ '/_/images/work/foursquare/city-guide/opinionator/content/stripping-back-sketch-three.png' | url }}" 
      width="1252" 
      alt="photo" />
    </div>
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/city-guide/opinionator/content/stripping-back-wire-one.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/city-guide/opinionator/content/stripping-back-wire-two.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/city-guide/opinionator/content/stripping-back-wire-three.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
    </div>
...
<figure class="img">
  <div class="multi col">
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/city-guide/opinionator/content/stripping-back-wire-four.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/city-guide/opinionator/content/stripping-back-wire-five.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/city-guide/opinionator/content/stripping-back-wire-six.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
    </div>
...
<figure class="img">
  <div class="multi col">
    ...
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/city-guide/opinionator/content/progression-design-sketch-one.png' | url }}" 
        width="1252" 
        alt="photo" />
      </div>
    </div>
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/city-guide/opinionator/content/progression-design-wire-one.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/city-guide/opinionator/content/progression-design-wire-two.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/city-guide/opinionator/content/progression-design-wire-three.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
    </div>
...
Testing for the updated Opinionator feature began with internal employee reviews, offering quick, candid feedback from colleagues familiar with the app's design. This was followed by beta testing with our trusted Superuser community<sup><a href="#fn-4" id="fnref-4" class="footnote">4</a></sup> via TestFlight, where feedback was gathered through structured surveys and informal discussions via email and in communication tools like Slack.
...
<figure class="img">
  <div class="multi col bg padding">
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/city-guide/opinionator/content/design-revisions-mock-one.png' | url }}" 
        width="746" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/city-guide/opinionator/content/design-revisions-mock-two.png' | url }}" 
        width="746" 
        alt="photo" />
      </div>
    </div>
...
<ol id="footnotes">
  <li id="fn-1">
    Version 1.0 of the Opinionator launched its own view, taking over the entire screen, and away from the venue page you were on.
    <a class="data-footnote-backref" href="#fnref-1">↩</a>
  </li>
  <li id="fn-2">
    By tailoring question sets to different user types, we could gather a broader range of responses while ensuring the experience felt purposeful and rewarding.
    <a class="data-footnote-backref" href="#fnref-2">↩</a>
  </li>
  <li id="fn-3">
    For example, while stacked cards could tease upcoming questions, they struggled to communicate a user's overall position in the flow. Progress bars, on the other hand, conveyed progression more clearly but risked feeling too functional or conventional.
    <a class="data-footnote-backref" href="#fnref-3">↩</a>
  </li>
   <li id="fn-4">
    Superusers (SUs) are a group of dedicated enthusiasts who ensure the information remains accurate and high-quality.
