---
title: Add & Edit Flow
metaDesc: "The City Guide Add & Edit Flow brought Foursquare’s venue editing tools to mobile—streamlining how users and Superusers update and create places on the go."
...
team:
  ["Matthew Dyson", "Ben Mackey", "Thomas Meng", "Zack Sheppard", "Tori Ugarte"]
...
While the existing desktop app offered robust tools for maintaining and creating venue data, it was built when desktop usage still outpaced mobile. For our dedicated Superuser community<sup><a href="#fn-1" id="fnref-1" class="footnote">1</a></sup>, this system was the backbone of their contributions to the platform. However, the lack of a mobile-friendly solution increased friction as mobile usage grew.

These screenshots of the desktop interface highlight the complexity of the existing system. While it worked well for detailed bulk edits, it was cumbersome and impractical for on-the-go use.
...
<figure class="img">
  <div class="multi col padding bg">
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/city-guide/add-edit-flow/content/old-edit-flow-one.png' | url }}" 
        width="1252" 
        alt="photo" />
      </div>
    </div>
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/city-guide/add-edit-flow/content/old-edit-flow-two.png' | url }}" 
        width="746" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/city-guide/add-edit-flow/content/old-edit-flow-three.png' | url }}" 
        width="746" 
        alt="photo" />
      </div>
    </div>
...
<span class="persona">{% personasvg "six.svg" %}</span>
</div>
</li>
<li>
<div class="card">
...
<div class="card">
<blockquote>
The editing tools aren't easy to get to when I'm using my phone. I have to open the website, log in, and navigate to the right place. By then, I'm already frustrated, and it doesn't feel worth the effort.
</blockquote>
<span class="persona">{% personasvg "four.svg" %}</span>
</div>
</li>
...
<figure class="img">
  <div class="multi col">
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/city-guide/add-edit-flow/content/scanability-sketch-one.png' | url }}" 
        width="1252" 
        alt="photo" />
      </div>
    </div>
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/city-guide/add-edit-flow/content/scanability-wireframe-one.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/city-guide/add-edit-flow/content/scanability-wireframe-two.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/city-guide/add-edit-flow/content/scanability-wireframe-three.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
    </div>
...
<figure class="img">
  <div class="multi col">
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/city-guide/add-edit-flow/content/toggle-sketch-one.png' | url }}" 
        width="1252" 
        alt="photo" />
      </div>
    </div>
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/city-guide/add-edit-flow/content/toggle-wireframe-one.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/city-guide/add-edit-flow/content/toggle-wireframe-two.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/city-guide/add-edit-flow/content/toggle-wireframe-three.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
    </div>
...
## The Add Flow: Expanding on the System
...
<figure class="img">
  <div class="multi col">
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/city-guide/add-edit-flow/content/add-flow-sketch-one.png' | url }}" 
        width="1252" 
        alt="photo" />
      </div>
    </div>
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/city-guide/add-edit-flow/content/add-flow-wireframe-one.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/city-guide/add-edit-flow/content/add-flow-wireframe-two.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/city-guide/add-edit-flow/content/add-flow-wireframe-three.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
    </div>
...
Splitting the flow into individual steps wasn't just a psychological trick; it also had tangible UX benefits:
...
<figure class="img">
  <div class="multi col">
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/city-guide/add-edit-flow/content/edit-flow-entry-point-wireframe-one.png' | url }}" 
        width="746" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/city-guide/add-edit-flow/content/edit-flow-entry-point-wireframe-two.png' | url }}" 
        width="746" 
        alt="photo" />
      </div>
    </div>
...
- **Empty State Handling**: If a search returned zero results, users were presented with a message prompting them to add a new venue.
...
<figure class="img">
  <div class="multi col">
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/city-guide/add-edit-flow/content/add-flow-entry-point-wireframe-one.png' | url }}" 
        width="746" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/city-guide/add-edit-flow/content/add-flow-entry-point-wireframe-two.png' | url }}" 
        width="746" 
        alt="photo" />
      </div>
    </div>
...
<ol id="footnotes">
  <li id="fn-1">
    Superusers (SUs) are the unsung heroes of Foursquare, ensuring the database of places stays reliable, detailed, and up to date.
