---
title: Room Finder
metaDesc: "Room Finder was an internal Foursquare Labs AR prototype helping employees navigate a new 45-room office through real-time spatial mapping and intuitive wayfinding."
...
Around this time, Augmented Reality (AR) was gaining traction in tech circles. Apple's release of ARKit<sup><a href="#fn-1" id="fnref-1" class="footnote">1</a></sup> marked a turning point, dramatically simplifying AR development for iPhones and iPads. With features like improved plane detection and real-world anchoring, AR suddenly became a practical solution for real-time navigation.
...
<figure class="img">
  <div class="multi col">
    <div class="multi row bg">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/labs/room-finder/content/increase-radius.png' | url }}" 
        width="1252" 
        alt="photo" />
      </div>
    </div>
...
<figure class="img">
  <div class="multi col">
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/labs/room-finder/content/establishing-the-interface-sketch-one.png' | url }}" 
        width="1252" 
        alt="photo" />
      </div>
    </div>
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/labs/room-finder/content/establishing-the-interface-wire-one.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/labs/room-finder/content/establishing-the-interface-wire-two.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/labs/room-finder/content/establishing-the-interface-wire-three.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
    </div>
...
<div class= "multi col bg padding">
  <div class="mutli row">
    <div>
      <img 
      src="{{ '/_/images/work/foursquare/labs/room-finder/content/architects-floorplan-drawing.png' | url }}" 
      width="1252" 
      alt="photo" />
    </div>
  </div>
...
<figure class="img">
  <div class="multi col">
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/labs/room-finder/content/color-coded-rooms-sketch-one.png' | url }}" 
        width="1252" 
        alt="photo" />
      </div>
       <!--
...
<figure class="img">
  <div class="multi col">
    <div class="multi row">
      <div class="bg">
        <img 
        src="{{ '/_/images/work/foursquare/labs/room-finder/content/notification-one.png' | url }}" 
        width="746" 
        alt="photo" />
      </div>
      <div class="bg">
        <img 
        src="{{ '/_/images/work/foursquare/labs/room-finder/content/notification-two.png' | url }}" 
        width="746" 
        alt="photo" />
      </div>
    </div>
...
<figure class="img">
  <div class="multi col">
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/labs/room-finder/content/widget-notification-sketch-one.png' | url }}" 
        width="1252" 
        alt="photo" />
      </div>
    </div>
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/labs/room-finder/content/widget-notification-wire-one.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/labs/room-finder/content/widget-notification-wire-two.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/labs/room-finder/content/widget-notification-wire-three.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
    </div>
...
<figure class="img">
  <div class="bg padding">
    <img 
    src="{{ '/_/images/work/foursquare/labs/room-finder/content/tron-race.png' | url }}" 
    width="1252" 
    alt="photo" />
  </div>
  <figcaption>
...
<figure class="img">
  <div class="multi col">
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/labs/room-finder/content/tron-lightcycle-sketch-one.png' | url }}" 
        width="1252" 
        alt="photo" />
      </div>
    </div>
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/labs/room-finder/content/tron-lightcycle-wire-one.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/labs/room-finder/content/tron-lightcycle-wire-two.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/labs/room-finder/content/tron-lightcycle-wire-three.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
    </div>
...
<figure class="img">
  <div class="multi col">
    <div class="multi row">
      <div class="bg padding">
        <img 
        src="{{ '/_/images/work/foursquare/labs/room-finder/content/app-icon.png' | url }}" 
        width="1252" 
        alt="photo" />
      </div>
    </div>
...
<ol id="footnotes">
  <li id="fn-1">
    ARKit was released as part of iOS 11 in September 2017
