---
title: Marsbot Audio
metaDesc: "Marsbot Audio is a Foursquare Labs prototype: a screen-free, audio-first walking assistant that plays contextual stories at nearby places via your headphones."
...
I began by venturing to the app stores to gain an understanding of the needs and wants of our target audience, as well as our soon-to-be competitor's strengths and weaknesses<sup><a href="#fn-1" id="fnref-1" class="footnote">1</a></sup>. In doing so, we could analyse product features and user experience whilst identifying the latest trends.
  ...
  <div class="multi col">
    <div class="multi row">
      <div class="padding bg">
        <img 
        src="{{ '/_/images/work/foursquare/labs/marsbot-audio/content/sticky-notes.png' | url }}" 
        width="1252" 
        alt="photo" />
      </div>
    </div>
...
<figure class="img">
  <div class="multi col">
    <div class="multi row">
      <div class="bg">
        <img 
        src="{{ '/_/images/work/foursquare/labs/marsbot-audio/content/new-perspective-screenshot.png' | url }}" 
        width="1252" 
        alt="photo" />
      </div>
    </div>
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/labs/marsbot-audio/content/new-perspective-sketch.png' | url }}" 
        width="1252" 
        alt="photo" />
      </div>
    </div>
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/labs/marsbot-audio/content/new-perspective-wireframe.png' | url }}" 
        width="1252" 
        alt="photo" />
      </div>
    </div>
...
<figure class="img">
  <div class="multi col">
    ...
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/labs/marsbot-audio/content/tribute-in-light-sketch.png' | url }}" 
        width="746" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/labs/marsbot-audio/content/tribute-in-light-wireframe-two.png' | url }}" 
        width="746" 
        alt="photo" />
      </div>
    </div>
...
<figure class="img">
  <div class="multi col">
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/labs/marsbot-audio/content/step-into-the-light-sketch-one.png' | url }}" 
        width="1252" 
        alt="photo" />
      </div>
    </div>
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/labs/marsbot-audio/content/step-into-the-light-wire-one.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/labs/marsbot-audio/content/step-into-the-light-wire-two.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/labs/marsbot-audio/content/step-into-the-light-wire-three.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
    </div>
...
<div class="multi col">
  <div class="mutli row bg padding">
    ...
    <div class="container" style=" color: var(--color-ink-muted); display: flex; font-size: var(--font-size-sm); line-height: var(--leading-normal); letter-spacing: var(--tracking-sm); margin-top: 8px;">
...
A traditional compass felt too heavy-handed<sup><a href="#fn-4" id="fnref-4" class="footnote">4</a></sup>. Circular, dominant, and visually loud, it would have interfered with what we'd already established: the grid, the pacing, the beams. So, we built something different.
...
<figure class="img">
  <div class="multi col">
    <div class="mutli row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/labs/marsbot-audio/content/a-sense-of-direction-sketch-one.png' | url }}" 
        width="1252" 
        alt="photo" />
      </div>
    </div>
    <div class="multi row">
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/labs/marsbot-audio/content/a-sense-of-direction-wire-one.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/labs/marsbot-audio/content/a-sense-of-direction-wire-two.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
      <div>
        <img 
        src="{{ '/_/images/work/foursquare/labs/marsbot-audio/content/a-sense-of-direction-wire-three.png' | url }}" 
        width="486" 
        alt="photo" />
      </div>
    </div>
...
<figure class="img">
  <div class="bg padding multi col">
    <div>
      <img 
      src="{{ '/_/images/work/foursquare/labs/marsbot-audio/content/wordmark-sketch.png' | url }}" 
      width="1252" 
      alt="photo" />
    </div>
    <div>
      <img 
      src="{{ '/_/images/work/foursquare/labs/marsbot-audio/content/wordmark-lockup.png' | url }}" 
      width="1252" 
      alt="photo" />
    </div>
  </div>
...
<ol id="footnotes">
  <li id="fn-1">
    Reviewing a wide range of feedback offered a swift grasp of different aspects.
    <a class="data-footnote-backref" href="#fnref-1">↩</a>
  </li>
  <li id="fn-2">
    Living in New York, I naturally gravitated toward something that echoed the city's grid: cross streets, avenues, blocks. But not everyone navigates a grid-based city. So the markers evolved, becoming less about specific intersections and more about pacing, a set distance marker subtly suggesting proximity
    <a class="data-footnote-backref" href="#fnref-2">↩</a>
  </li>
  <li id="fn-3">
    The Tribute in Light is an artwork commemorating the September 11 attacks. It consists of 88 vertical searchlights arranged in two columns of light to represent the Twin Towers. It stands six blocks south of the World Trade Center on top of the Battery Parking Garage in New York City (Source: Wikipedia).
    <a class="data-footnote-backref" href="#fnref-3">↩</a>
  </li>
   <li id="fn-4">
    Initially, I explored placing the compass at the top of the UI, in an attempt to convey direction but we would run into issues with it overlapping our beams of light. In the second sketch, the traditional compass took up too much space, leaving the bottom of the UI feeling cluttered. The last sketch provided a more stripped-back aesthetic while offering just enough context.
